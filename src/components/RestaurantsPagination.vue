  ...
  <nav aria-label="Page navigation example">
    <ul class="pagination">
      ...
      <li v-show="previousPage" class="page-item">
        <router-link class="page-link" aria-label="Previous" :to="{query: { categoryId, page: previousPage }}">
      ...
      <li v-show="nextPage" class="page-item">
        <router-link class="page-link" aria-label="Next" :to="{query: {categoryId, page: nextPage }}">
