<template>
    <div class="album py-5 bg-light">
        <div class="container">
            <UserProfileCard v-bind:initial-profile="profile" v-bind:initial-is-followed="isFollowed" v-bind:current-user="currentUser"/>
            <div class="row">
                <div class="col-md-4">
                    <UserFollowingCard v-bind:profile="profile" />
                    <br>
                    <UserFollowerCard v-bind:profile="profile"/>
                </div>
                <div class="col-md-8">
                    <UserCommentsCard v-bind:comments="profile.Comments"/>
                </div>
            </div>
        </div>
    </div>
...
import UserFollowerCard from '../components/UserFollowersCard'
