  ...
  <div class="container py-5">
    <form v-on:submit.stop.prevent="handleSubmit">
      ...
      <div class="form-group">
        ...
        <img v-if="image" v-bind:src="image" class="d-block img-thumbnail mb-3" width="200" height="200">
        <input v-on:change="handleFileChange" id="image" type="file" name="image" accept="image/*" class="form-control-file" />
      </div>
...
export default {
  ...
  methods: {
    fetchUser() {
      ...
      this.image = dummyData.profile.image;
    },
